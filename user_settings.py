...
feeds = [
        ['12356', 'http://datamine.mta.info/mta_esi.php?key=' + mta_api_key + '&feed_id=1', timestamp_from_gtfs_realtime],
        ['ACE', 'http://datamine.mta.info/mta_esi.php?key=' + mta_api_key + '&feed_id=26', timestamp_from_gtfs_realtime],
        ['BDFM', 'http://datamine.mta.info/mta_esi.php?key=' + mta_api_key + '&feed_id=21', timestamp_from_gtfs_realtime],
        ['G', 'http://datamine.mta.info/mta_esi.php?key=' + mta_api_key + '&feed_id=31', timestamp_from_gtfs_realtime],
        ['JZ', 'http://datamine.mta.info/mta_esi.php?key=' + mta_api_key + '&feed_id=36', timestamp_from_gtfs_realtime],
        ['L', 'http://datamine.mta.info/mta_esi.php?key=' + mta_api_key + '&feed_id=2', timestamp_from_gtfs_realtime],
        ['NQRW', 'http://datamine.mta.info/mta_esi.php?key=' + mta_api_key + '&feed_id=16', timestamp_from_gtfs_realtime],
        ['SIR', 'http://datamine.mta.info/mta_esi.php?key=' + mta_api_key + '&feed_id=11', timestamp_from_gtfs_realtime]
        ]
